...
export default function RegisterForm() {
    ...
    const initialTab = searchParams.get("type") === "content-creator" ? "creator" : "company"
    ...
    // Stelle sicher, dass die richtigen Rollen-Werte an das Backend gesendet werden
    // Ändere im handleSubmit:
